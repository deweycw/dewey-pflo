module Reaction_Sandbox_Gt_Lactate_class
#include "petsc/finclude/petscsys.h"
  ...
  type, public, &
    extends(reaction_sandbox_base_type) :: &
      reaction_sandbox_gt_lactate_type
  ...
  contains
    procedure, public :: ReadInput => GtLactateReadInput
    procedure, public :: Setup => GtLactateSetup
    procedure, public :: AuxiliaryPlotVariables => GtLactateAuxiliaryPlotVariables
    procedure, public :: Evaluate => GtLactateEvaluate
    procedure, public :: UpdateKineticState => GtLactateUpdateKineticState
  end type reaction_sandbox_gt_lactate_type

  public :: GtLactateCreate, &
            GtLactateSetup
contains
! ************************************************************************** !
function GtLactateCreate()
  !
  ! Allocates GtLactate reaction object.
  !
  implicit none
  class(reaction_sandbox_gt_lactate_type), pointer :: GtLactateCreate
  allocate(GtLactateCreate)
  GtLactateCreate%auxiliary_offset = UNINITIALIZED_INTEGER
  GtLactateCreate%h_ion_id = UNINITIALIZED_INTEGER
  GtLactateCreate%fe2_id = UNINITIALIZED_INTEGER
  GtLactateCreate%acetate_id = UNINITIALIZED_INTEGER
  GtLactateCreate%lactate_id = UNINITIALIZED_INTEGER
  GtLactateCreate%bicarbonate_id = UNINITIALIZED_INTEGER
  GtLactateCreate%o2aq_id = UNINITIALIZED_INTEGER
  GtLactateCreate%mineral_id = UNINITIALIZED_INTEGER
  GtLactateCreate%xim_id = UNINITIALIZED_INTEGER

  GtLactateCreate%rate_constant1 = UNINITIALIZED_DOUBLE
  GtLactateCreate%rate_constant2 = UNINITIALIZED_DOUBLE
  GtLactateCreate%Ka = UNINITIALIZED_DOUBLE
  GtLactateCreate%Kl = UNINITIALIZED_DOUBLE
  GtLactateCreate%Y = UNINITIALIZED_DOUBLE
  GtLactateCreate%m = UNINITIALIZED_DOUBLE
  GtLactateCreate%chi = UNINITIALIZED_DOUBLE
  GtLactateCreate%o2_threshold = UNINITIALIZED_DOUBLE
  GtLactateCreate%test = UNINITIALIZED_INTEGER

  nullify(GtLactateCreate%next)
end function GtLactateCreate
! ************************************************************************** !
subroutine GtLactateReadInput(this,input,option)
  !
  ...
  use String_module
  implicit none
  class(reaction_sandbox_gt_lactate_type) :: this
  type(input_type), pointer :: input
  type(option_type) :: option
  character(len=MAXWORDLENGTH) :: word
  character(len=MAXSTRINGLENGTH) :: error_string
  error_string = 'CHEMISTRY,REACTION_SANDBOX,GTLACTATE'
  ...
  if (Uninitialized(this%rate_constant1) .or. &
    ...
    option%io_buffer = 'K_DISSOLUTION, K_PRECIPITATION, KA, KL, Y, M, CHI, and O2_THRESHOLD must be set for &
      REACTION_SANDBOX_GT_LACTATE.'
    call PrintErrMsg(option)
  endif
end subroutine GtLactateReadInput
! ************************************************************************** !
subroutine GtLactateSetup(this,reaction,option)
  !
...
end subroutine GtLactateSetup
! ************************************************************************** !
subroutine GtLactateAuxiliaryPlotVariables(this,list,reaction,option)
  !
  ...
  word = 'Gt Lactate Sandbox Rate'
  units = 'mol/m^3-sec'
  call OutputVariableAddToList(list,word,OUTPUT_RATE,units, &
                                REACTION_AUXILIARY, &
                                this%auxiliary_offset+1)
  
end subroutine GtLactateAuxiliaryPlotVariables
! ************************************************************************** !
subroutine GtLactateEvaluate(this, Residual,Jacobian,compute_derivative, &
  ...
  PetscReal :: Rate, Rate_Ac, Rate_Lac, Rate_Proton
  ...
  if (dabs(rt_auxvar%mnrl_rate(imnrl)) > 1.d-40) then
    option%io_buffer = 'For REACTION_SANDBOX_GT_LACTATE to function correctly, &
  ...
  dG0 = (-273.4d0) ! kJ / mol lactate; dG0 for FeIII in goethite as electron acceptor; Kocar & Fendorf 2009
...
end subroutine GtLactateEvaluate
! ************************************************************************** !
subroutine GtLactateUpdateKineticState(this,rt_auxvar,global_auxvar, &
...
end subroutine GtLactateUpdateKineticState
end module Reaction_Sandbox_Gt_Lactate_class