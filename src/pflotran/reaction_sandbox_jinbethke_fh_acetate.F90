...
subroutine JinBethkeFerrihydriteAcetateEvaluate(this, Residual,Jacobian,compute_derivative, &
  ...
  Ac = reaction%free_conc(this%acetate_id) * molality_to_molarity * &
    reaction%free_conc(this%acetate_id) 
  Proton = reaction%free_conc(this%h_ion_id) * molality_to_molarity * &
    reaction%free_conc(this%h_ion_id) 
  Fe2 = reaction%free_conc(this%fe2_id) * molality_to_molarity * &
    reaction%free_conc(this%fe2_id) 
  Bicarbonate = reaction%free_conc(this%bicarbonate_id) * molality_to_molarity * &
    reaction%free_conc(this%bicarbonate_id) 
  O2aq = reaction%free_conc(this%o2aq_id) * molality_to_molarity * &
    reaction%free_conc(this%o2aq_id) 

  DOMaq = reaction%free_conc(this%domaq_id) * molality_to_molarity * &
    reaction%free_conc(this%domaq_id)
