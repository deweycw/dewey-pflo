module Reaction_Sandbox_JinBethke_Ferrihydrite_Lactate_class
#include "petsc/finclude/petscsys.h"
  ...
  type, public, &
    extends(reaction_sandbox_base_type) :: &
      reaction_sandbox_jinbethke_ferrihydrite_lactate_type
  ...
  contains
    procedure, public :: ReadInput => JinBethkeFerrihydriteLactateReadInput
    procedure, public :: Setup => JinBethkeFerrihydriteLactateSetup
    procedure, public :: AuxiliaryPlotVariables => JinBethkeFerrihydriteLactateAuxiliaryPlotVariables
    procedure, public :: Evaluate => JinBethkeFerrihydriteLactateEvaluate
    procedure, public :: UpdateKineticState => JinBethkeFerrihydriteLactateUpdateKineticState
  end type reaction_sandbox_jinbethke_ferrihydrite_lactate_type

  public :: JinBethkeFerrihydriteLactateCreate, &
            JinBethkeFerrihydriteLactateSetup
contains
! ************************************************************************** !
function JinBethkeFerrihydriteLactateCreate()
  !
  ! Allocates FhLactate reaction object.
  !
  implicit none
  class(reaction_sandbox_jinbethke_ferrihydrite_lactate_type), pointer :: JinBethkeFerrihydriteLactateCreate
  allocate(JinBethkeFerrihydriteLactateCreate)
  JinBethkeFerrihydriteLactateCreate%auxiliary_offset = UNINITIALIZED_INTEGER
  JinBethkeFerrihydriteLactateCreate%h_ion_id = UNINITIALIZED_INTEGER
  JinBethkeFerrihydriteLactateCreate%fe2_id = UNINITIALIZED_INTEGER
  JinBethkeFerrihydriteLactateCreate%acetate_id = UNINITIALIZED_INTEGER
  JinBethkeFerrihydriteLactateCreate%lactate_id = UNINITIALIZED_INTEGER
  JinBethkeFerrihydriteLactateCreate%bicarbonate_id = UNINITIALIZED_INTEGER
  JinBethkeFerrihydriteLactateCreate%o2aq_id = UNINITIALIZED_INTEGER
  JinBethkeFerrihydriteLactateCreate%mineral_id = UNINITIALIZED_INTEGER
  JinBethkeFerrihydriteLactateCreate%fim_id = UNINITIALIZED_INTEGER
  ...
  JinBethkeFerrihydriteLactateCreate%chi = UNINITIALIZED_DOUBLE
  JinBethkeFerrihydriteLactateCreate%o2_threshold = UNINITIALIZED_DOUBLE

  nullify(JinBethkeFerrihydriteLactateCreate%next)
end function JinBethkeFerrihydriteLactateCreate
! ************************************************************************** !
subroutine JinBethkeFerrihydriteLactateReadInput(this,input,option)
  !
  ...
  error_string = 'CHEMISTRY,REACTION_SANDBOX,JINBETHKE_FERRIHYDRITE_LACTATE'
...
end subroutine JinBethkeFerrihydriteLactateReadInput
! ************************************************************************** !
subroutine JinBethkeFerrihydriteLactateSetup(this,reaction,option)
  !
...
end subroutine JinBethkeFerrihydriteLactateSetup
! ************************************************************************** !
subroutine JinBethkeFerrihydriteLactateAuxiliaryPlotVariables(this,list,reaction,option)
  !
...
end subroutine JinBethkeFerrihydriteLactateAuxiliaryPlotVariables
! ************************************************************************** !
subroutine JinBethkeFerrihydriteLactateEvaluate(this, Residual,Jacobian,compute_derivative, &
  ...
  if (dabs(rt_auxvar%mnrl_rate(imnrl)) > 1.d-40) then
    option%io_buffer = 'For JINBETHKE_FERRIHYDRITE_LACTATE to function correctly, &
  ...
  k_precip = this%r_precip
    ...
    ! dG0 =   -347.3 kJ per mol Lactate- , Kocar & Fendorf 2009
...
end subroutine JinBethkeFerrihydriteLactateEvaluate
! ************************************************************************** !
subroutine JinBethkeFerrihydriteLactateUpdateKineticState(this,rt_auxvar,global_auxvar, &
...
end subroutine JinBethkeFerrihydriteLactateUpdateKineticState
end module Reaction_Sandbox_JinBethke_Ferrihydrite_Lactate_class